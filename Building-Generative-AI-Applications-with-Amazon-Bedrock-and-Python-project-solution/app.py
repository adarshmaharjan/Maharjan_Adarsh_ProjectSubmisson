...
if prompt := st.chat_input("What would you like to know?"):
    ...
    if valid_prompt(prompt, model_id):
        if kb_results := query_knowledge_base(prompt, kb_id):
            ...
            response = "I couldn't find relevant information in the knowledge base. Please check the Knowledge Base ID and ensure it has been synced with data."
    else:
